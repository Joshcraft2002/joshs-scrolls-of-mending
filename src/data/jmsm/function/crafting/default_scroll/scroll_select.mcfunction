...
execute if score @s jmsm.crafting_level matches 1 run function jmsm:crafting/default_scroll/greater_scroll
execute if score @s jmsm.crafting_level matches 2 run function jmsm:crafting/default_scroll/scroll
execute if score @s jmsm.crafting_level matches 3 run function jmsm:crafting/default_scroll/lesser_scroll
