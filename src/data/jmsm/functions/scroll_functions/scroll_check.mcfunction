...
scoreboard players operation jmsm:dmg_calc_result jmsm.data /= jmsm:2 jmsm.data

execute if score @s jmsm.xp < jmsm:dmg_calc_result jmsm.data run function jmsm:scroll_functions/fizzle
execute if score @s jmsm.xp >= jmsm:dmg_calc_result jmsm.data run function jmsm:scroll_functions/use_scroll