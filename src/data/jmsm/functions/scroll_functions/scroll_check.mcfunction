...
scoreboard players operation jmsm:cost_calc.total jmsm.data /= jmsm:2 jmsm.data

execute if score @s jmsm.xp < jmsm:cost_calc.total jmsm.data run function jmsm:scroll_functions/fizzle
execute if score @s jmsm.xp >= jmsm:cost_calc.total jmsm.data run function jmsm:scroll_functions/use_scroll