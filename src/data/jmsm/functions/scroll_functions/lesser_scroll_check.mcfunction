...
# repair cost (from 25%)
scoreboard players operation jmsm:dmg_calc_result jmsm.data *= jmsm:config.lesser_scroll_cost jmsm.data
scoreboard players operation jmsm:dmg_calc_result jmsm.data /= jmsm:100 jmsm.data
scoreboard players operation jmsm:dmg_calc_result jmsm.data /= jmsm:4 jmsm.data

execute if score @s jmsm.xp < jmsm:dmg_calc_result jmsm.data run function jmsm:scroll_functions/fizzle
execute if score @s jmsm.xp >= jmsm:dmg_calc_result jmsm.data run function jmsm:scroll_functions/use_lesser_scroll
