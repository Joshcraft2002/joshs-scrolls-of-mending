...
execute store result score jmsm:head_damage jmsm.data run data get storage jmsm:scroll gear_check.components.minecraft:damage
execute unless score jmsm:head_damage jmsm.data matches 1.. run return 1

# max damage checks
execute unless score jmsm:head_max_damage jmsm.data matches 1.. store result score jmsm:head_max_damage jmsm.data run data get storage jmsm:scroll gear_check.components.minecraft:max_damage
execute unless score jmsm:head_max_damage jmsm.data matches 1.. if data storage jmsm:scroll gear_check.components."!minecraft:max_damage" run return 1
...
execute unless score jmsm:head_max_damage jmsm.data matches 1.. if data storage jmsm:scroll {gear_check:{id:"minecraft:turtle_helmet"}} run scoreboard players set jmsm:head_max_damage jmsm.data 275
